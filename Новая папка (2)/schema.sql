...
CREATE INDEX IF NOT EXISTS idx_orders_status_date    ON orders (status, closed_at);
CREATE INDEX IF NOT EXISTS idx_order_items_order     ON order_items (order_id, status);
CREATE INDEX IF NOT EXISTS idx_order_items_station   ON order_items (status, dish_id);
CREATE INDEX IF NOT EXISTS idx_ingredients_low       ON ingredients (stock_qty, min_qty);
CREATE INDEX IF NOT EXISTS idx_movements_created     ON stock_movements (created_at DESC);
CREATE INDEX IF NOT EXISTS idx_requests_status       ON restock_requests (status, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_schedule_date         ON schedule (work_date, employee_id);
