/* =========================================================
   ...
   XSS-safe: любая вставка текста — через textContent.
   ========================================================= */
    ...
    canvas.addEventListener("mousemove", (e) => {
        ...
        if (idx >= 0) {
            ...
            const lines = [
                ...
                { text: "Выручка: " + fmtMoney(d.value) },
            ];
            if (d.qty != null) lines.push({ text: "Продано: " + d.qty + " шт" });
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (donutData.length) {
        ...
        if (c && c.parentElement) {
            ...
            c.parentElement.replaceChildren(p);
        }
    }
